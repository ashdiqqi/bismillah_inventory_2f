			...
			<form method="POST" enctype="multipart/form-data" action="">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" name="maintainer" class="form-control" placeholder="Maintainer ..."
							required="">
					</div>

					<div class="form-group">
						<label>Deskripsi</label>
						<textarea placeholder="Deskripsi ..." class="form-control" rows="5" name="deskripsi"
			...
			<div class="modal-content">
				...
				<form method="POST" enctype="multipart/form-data" action="">
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Nama Maintainer</label>
							<input value="<?php echo $d['maintainer'] ?>" type="text" name="maintainer" class="form-control"
								placeholder="Maintainer ..." required="">
						</div>
						<div class="form-group">
							<label>Deskripsi</label>
							<textarea class="form-control" placeholder="Deskripsi ..." rows="5" name="deskripsi"
								style="white-space: pre-line;" required=""><?php echo $d['deskripsi'] ?></textarea>
						</div>
						<div class="form-group">
							<label>Foto</label>
							<input type="file" name="foto" class="form-control" placeholder required="">
