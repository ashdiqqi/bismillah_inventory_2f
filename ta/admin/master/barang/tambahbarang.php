...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO barang (id_barang, nama_barang, maintainer, qty_tersedia, qty_total, foto_barang, deskripsi) 
    VALUES ('$id_barang','$nama_barang', '$maintainer', '$qty_total', '$qty_total', '$foto', '$deskripsi')";
